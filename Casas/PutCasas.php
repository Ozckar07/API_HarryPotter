<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'PUT'){
        ...
        $sql = "UPDATE casa SET NOMBRE_CASA='$NOMBRE_CASA', COLOR_CASA='$COLOR_CASA', VIRTUD_CASA='$VIRTUD_CASA', NOMBRE_FANTASMA_CASA='$NOMBRE_FANTASMA_CASA' WHERE ID_CASA='$ID_CASA'";
