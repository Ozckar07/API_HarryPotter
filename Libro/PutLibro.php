<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'PUT'){
        ...
        $sql = "UPDATE libros SET AUTOR_LIBRO='$AUTOR_LIBRO', SINOPSIS_LIBRO='$SINOPSIS_LIBRO', ANO_PUBLICACION_LIBRO='$ANO_PUBLICACION_LIBRO', EDITORIAL_LIBRO='$EDITORIAL_LIBRO', CODIGO_ISBN_LIBRO='$CODIGO_ISBN_LIBRO', CRONOLOGIA_LIBRO='$CRONOLOGIA_LIBRO' WHERE ID_LIBRO='$ID_LIBRO'";
