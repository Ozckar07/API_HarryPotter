<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        $FECHA_NACIMIENTO_PERSONAJE = $_POST['FECHA_NACIMIENTO$FECHA_NACIMIENTO_PERSONAJE'];
        ...
        $sql = "INSERT INTO personaje VALUES('$ID_UNIVERSO', '$ID_LIBRO', '$ID_PELICULA', '$TITULO_PELICULA', '$DIRECTOR_PELICULA', '$PRODUCTORA_PELICULA', '$ANO_ESTRENO_PELICULA', '$SINOPSIS_PELICULA')";
